...
public class QQuestion extends EntityPathBase<Question> {
    ...
    private static final long serialVersionUID = -1889627367L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QQuestion question = new QQuestion("question");

    public final ListPath<QuestionCategory, EnumPath<QuestionCategory>> categories = this.<QuestionCategory, EnumPath<QuestionCategory>>createList("categories", QuestionCategory.class, EnumPath.class, PathInits.DIRECT2);
