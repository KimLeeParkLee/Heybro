...
public class RoutineDataInitializer implements CommandLineRunner {
    ...
    private List<Routine> createInitialRoutines() {
        ...
        routines.add(Routine.builder()
                ...
                .elementList(Arrays.asList(
                        RoutineElement.builder().step(1).name("세럼 펌핑하기").content("적당량의 세럼을 손에 펌핑합니다.").detailImage("https://drive.google.com/uc?export=view&id=1RTfgJTZMZsdG_YocYk1S1fqxFyS77SMH").build(),
                        RoutineElement.builder().step(2).name("얼굴에 펴 바르기").content("피부 중심에서 바깥쪽으로 부드럽게 발라주세요.").detailImage("https://drive.google.com/uc?export=view&id=1uF2XSn-dSZgWS0ErrPA0HZLajQibjo9k").build(),
                        RoutineElement.builder().step(3).name("손으로 감싸 흡수시키기").content("손바닥으로 얼굴을 감싸며 흡수시킵니다.").detailImage("https://drive.google.com/uc?export=view&id=1i6Vas3l1rYYA98PImxilOPjKtNLH-XPR").build()
                ))
                .recommendedProductList(new ArrayList<>(Arrays.asList(
                        RecommendedProduct.builder()
        ...
        routines.add(Routine.builder()
                ...
                .elementList(Arrays.asList(
                        RoutineElement.builder().step(1).name("식후 30분 뒤 양치").content("식사 후 30분 뒤 양치하세요.").detailImage("https://drive.google.com/uc?export=view&id=1O4EW0cPIrO6GMEC_A1z5u9Omp0IOmq9A").build(),
                        RoutineElement.builder().step(2).name("혀 닦아 마무리하기").content("혀까지 부드럽게 닦아 마무리합니다.").detailImage("https://drive.google.com/uc?export=view&id=1K1slpjj6_enGJPEOIgJ0GlFOPto9B8KA").build()
                ))
                .recommendedProductList(new ArrayList<>(Arrays.asList(
                        RecommendedProduct.builder()
        ...
        routines.add(Routine.builder()
                ...
                .elementList(Arrays.asList(
                        RoutineElement.builder().step(1).name("거리 두고 분사하기").content("얼굴에서 20cm 정도 거리를 두고 미스트를 분사하세요.").detailImage("https://drive.google.com/uc?export=view&id=1f3AHq5ql4TEq183YgqNOgRlYAyFKMc5S").build(),
                        RoutineElement.builder().step(2).name("두드려 흡수시키기").content("가볍게 손으로 두드려 흡수시킵니다.").detailImage("https://drive.google.com/uc?export=view&id=1fAd20GF1WSN96K_Ko3g8nzel57nMQ78v").build()
                ))
                .recommendedProductList(new ArrayList<>(Arrays.asList(
                        RecommendedProduct.builder()
        ...
        routines.add(Routine.builder()
                ...
                .elementList(Arrays.asList(
                        RoutineElement.builder().step(1).name("손등에 덜어 문지르기").content("적당량을 손등에 짜서 양손으로 문질러 주세요.").detailImage("https://drive.google.com/uc?export=view&id=1Y14-VtzzrJn1kuvkxOIHEG6W2Y7-MNH7").build(),
                        RoutineElement.builder().step(2).name("손가락과 큐티클에 바르기").content("손가락 사이와 손톱 큐티클까지 꼼꼼히 발라주세요.").detailImage("https://drive.google.com/uc?export=view&id=18Y5zse9EGdp-dn2IKc9Lh7f6IobkZtci").build()
                ))
                .recommendedProductList(new ArrayList<>(Arrays.asList(
                        RecommendedProduct.builder()
        ...
        routines.add(Routine.builder()
                ...
                .elementList(Arrays.asList(
                        RoutineElement.builder().step(1).name("클렌징 오일로 녹이기").content("클렌징 오일로 메이크업과 노폐물을 녹여줍니다.").detailImage("https://drive.google.com/uc?export=view&id=1VM1u2BipMGZDowo3kYc3v-tWcWNdKB6r").build(),
                        RoutineElement.builder().step(2).name("폼 클렌저로 세안하기").content("폼 클렌저로 거품을 내어 피부결 방향으로 세안합니다.").detailImage("https://drive.google.com/file/d/15ql1api0CqXVGslzbEo2Gv1R9wpgFrMZ/view?usp=drive_link").build(),
                        RoutineElement.builder().step(3).name("미온수로 헹궈내기").content("미지근한 물로 꼼꼼히 헹궈냅니다.").detailImage("https://drive.google.com/file/d/1LY4HyRDf3K1qlGwNcrfY6D6BLJivURAy/view?usp=drive_link").build()
                ))
                .recommendedProductList(new ArrayList<>(Arrays.asList(
                        RecommendedProduct.builder()
        ...
        routines.add(Routine.builder()
                ...
                .elementList(Arrays.asList(
                        RoutineElement.builder().step(1).name("크림 덜어내기").content("손가락 끝에 크림을 소량씩 덜어냅니다.").detailImage("https://drive.google.com/file/d/1FKXTI_lB2JWSUjZfaIJe9b4HAfFxVwdt/view?usp=drive_link").build(),
                        RoutineElement.builder().step(2).name("얼굴 부위별로 바르기").content("볼, 이마, 턱, 코 순으로 발라주세요.").detailImage("https://drive.google.com/file/d/1Iw0lwkdhT2bE1C612-Dri7jn9tIIQLCR/view?usp=drive_link").build(),
                        RoutineElement.builder().step(3).name("눌러서 흡수시키기").content("손바닥으로 지그시 눌러 흡수시킵니다.").detailImage("https://drive.google.com/file/d/1wDLGfIBMFjC52FNgn1KCM89d6LIuZHDE/view?usp=drive_link").build()
                ))
                .recommendedProductList(new ArrayList<>(Arrays.asList(
                        RecommendedProduct.builder()
